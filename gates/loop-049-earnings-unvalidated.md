# Gates: loop 049 earnings unvalidated gate

Scope: UNVALIDATED_FOR_LIVE_OPTIONS_PNL visible; estimated paper labels kept.

- [x] G1: Earnings unvalidated and radar chrome tests pass.
  CHECK: node --test cipher-system/web/test/earnings-unvalidated.test.mjs cipher-system/web/test/earnings-radar-ui.test.mjs
  EXPECT: /fail 0/
