# Gates: loop 081 journal entries scrollport

Scope: trader journal entries scroll in a named overflow-x/y region.

- [x] G1: Remaining chrome (journal needles) still passes.
