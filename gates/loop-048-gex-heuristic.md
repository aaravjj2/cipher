# Gates: loop 048 GEX heuristic copy

Scope: remaining GEX panels state public-OI heuristic; heatmap geometry unchanged.

- [x] G1: GEX copy and heatmap tests pass.
  CHECK: node --test cipher-system/web/test/gex-heuristic-copy.test.mjs cipher-system/web/test/heatmap-accessibility.test.mjs cipher-system/web/test/morning-brief-ui.test.mjs
  EXPECT: /fail 0/
