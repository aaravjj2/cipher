...
export function Autopilot() {
  ...
  const zeroTradeHealthy = data.executor.operating_state === "HEALTHY_NO_SETUP" && data.daily_trace.paper_submissions === 0;
  const steps = [
    ...
    ["Paper execution", zeroTradeHealthy ? "0 trades · healthy no-trade" : `${data.daily_trace.paper_submissions} submissions`],
