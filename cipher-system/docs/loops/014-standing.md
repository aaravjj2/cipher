# Loop 014 plan — Standing chrome

**Goal:** Flatten chrome to DESIGN.md surfaces without behavior change.

**Files:** `web/src/components/panels/Standing.tsx` plus `web/test/remaining-chrome-ui.test.mjs`.

**Preserve:** no live orders in comments/UI
