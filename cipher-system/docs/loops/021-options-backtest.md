# Loop 021 plan — Options Backtest chrome

**Goal:** Flatten chrome to DESIGN.md surfaces without behavior change.

**Files:** `web/src/components/panels/OptionsBacktest.tsx` plus `web/test/remaining-chrome-ui.test.mjs`.

**Preserve:** no broker access
