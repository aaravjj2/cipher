# Loop 011 plan — Company Context chrome

**Goal:** Flatten chrome to DESIGN.md surfaces without behavior change.

**Files:** `web/src/components/panels/CompanyContext.tsx` plus `web/test/remaining-chrome-ui.test.mjs`.

**Preserve:** conflicts never silently resolved
