# Loop 028 plan — Operator Status chrome

**Goal:** Flatten chrome to DESIGN.md surfaces without behavior change.

**Files:** `web/src/components/panels/OperatorStatus.tsx` plus `web/test/remaining-chrome-ui.test.mjs`.

**Preserve:** No execution capability
