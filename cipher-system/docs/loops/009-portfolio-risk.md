# Loop 009 plan — Portfolio Risk chrome

**Goal:** Flatten chrome to DESIGN.md surfaces without behavior change.

**Files:** `web/src/components/panels/PortfolioRisk.tsx` plus `web/test/remaining-chrome-ui.test.mjs`.

**Preserve:** Research only · no broker sync · no order actions
