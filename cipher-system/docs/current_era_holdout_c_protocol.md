...
- `2020-01-01` through `2023-12-31`: development only. It may support schema
  validation and factor design but cannot provide final promotion evidence.
- `2024-01-01` through `2025-12-31`: candidate final Holdout C. It must be
...
and completeness audit of the frozen nine-symbol panel over 2024-2025. Only if
